    ...
    <ScrollView className='flex-1 bg-white'>
      <View className='flex-1 bg-white '>
        ...
        <ReactNativeModal isVisible={verification.state === 'pending'} onModalHide={() => { if (verification.state === 'success') setShowSuccessModal(true) }}>
          <View className=' bg-white px-7 py-9 rounded-2xl mih-h-[300px]'>
            <Text className='text-xl font-JakartaExtraBold mb-2 '>Verification</Text>
            ...
            {verification.error && (
              <Text className='text-red-50- text-sm mt-1'>
                {verification.error}
              </Text>
            )}
